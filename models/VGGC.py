...
class VGGC(nn.Module):
    """ The VGG-C CNN architecture as described in the 2014 paper 
    ...
    def __init__(self, n_class):
        ...
        self.conv3_3 = nn.Conv2d(256,256,kernel_size=1,stride=1,padding=0,padding_mode='reflect') 
        ...
        self.conv4_3 = nn.Conv2d(512,512,kernel_size=1,stride=1,padding=0,padding_mode='reflect') 
        ...
        self.conv5_3 = nn.Conv2d(512,512,kernel_size=1,stride=1,padding=0,padding_mode='reflect') 
